  ...
  return (
    <header className="d-flex align-items-center justify-content-between px-4 sticky-top text-white" style={{height: '5rem', backgroundColor: '#111111', borderBottom: '1px solid #2a2a30', zIndex: 20}}>
      ...
      <div className="d-flex align-items-center gap-4">
        ...
        <button className="btn p-0 text-secondary position-relative border-0 shadow-none" style={{background: 'transparent'}}
        ...
        >
          ...
          <span className="position-absolute top-0 end-0 rounded-circle" style={{width: '8px', height: '8px', backgroundColor: '#0d6efd', border: '1px solid #0c0f17'}}></span>
        </button>
