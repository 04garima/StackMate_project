...
function CollegeDashboard() {
  ...
  return (
    <div className="fade-in">
      <h1 className="fw-bold mb-4" style={{color:'#fff'}}>College Overview</h1>
      ...
      <div className="row g-4 mb-4">
        <div className="col-12">
          <div className="rounded-3 p-4" style={{background:'var(--bg-card)', border:'1px solid var(--border-subtle)', transition:'border-color 0.3s'}}
            ...
            <p className="mb-1 text-uppercase fw-bold" style={{color:'var(--text-muted)', fontSize:'0.8rem', letterSpacing:'0.08em'}}>Total Students Affiliated</p>
            <h2 className="fw-bold mb-0" style={{color:'#fff'}}>{stats.totalStudents}</h2>
          </div>
        </div>
      </div>

      <div className="row g-4">
        {[{title:'Most Offered Skills (Your Students)', data: stats.mostOffered}, {title:'Most Wanted Skills (Your Students)', data: stats.mostWanted}].map(section => (
